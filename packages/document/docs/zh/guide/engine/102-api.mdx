...
*setter*  [TimelineEffect](/zh/guide/intro/3-data-interface.html#timelineeffect)  运行效果

### data
*setter*  [TimelineRow](/zh/guide/intro/3-data-interface.html#timelinerow)[] 运行数据
